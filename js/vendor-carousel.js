...
class VendorCarousel {
  constructor() {
    ...
    this.vendorLogos = [
      ...
      'dragon_painter.png',
      'DrizzleDrool.png',
      'Fanatic_Pufferfish.png',
      'Fights_and_Fancy.png',
      'FourScore.png',
      'GothWood.jpg',
      'HangedDragon.png',
      'HannahC.png',
      'HearthValley.png',
      'HillmansHandmade.png',
      'Hullabailu.png',
      'Jackalope_Roleplaying.png',
      'KandyKitten.png',
      'KookyCandle.png',
      'Leaky_Teacup.png',
      'LuckyLeafTeas.png',
      ...
      'MiniMiglets.png',
      'NintendoNottingham.png',
      'PickledPenniesPrints.png',
      'Pocket_Fox_Games.png',
      'PrintIsDead.png',
      'RachelHanley.png',
      'Rat_King_Umi.png',
      'RollMightyLeather.png',
      'Rose_and_Reverie.png',
      'SB_Party.jpg',
      'TabletopSmithy.png',
      'TheDiceCup.png',
      'ThePrintTavern.jpg',
      'Treasures_of_Astrus.png',
      'unrelenting_hobby.png',
      'ValkyrieRPG.png',
      'Vurona.png',
      'WarlocksWicks.png',
      'YviesImaginarium.png'
    ];
